...
# LED_PIN = 25 
# ============= SERVO SETTINGS =============
# Changed from 18 to 12 to avoid conflict with COLOR_S1 (GPIO 18)
SERVO_PIN = 12  # GPIO12 / Pin 32
...
SERVO_GREEN = SERVO_GOOD  # Green/unripe bean bin (same as SERVO_GOOD)
SERVO_RED = SERVO_BAD     # Red/overripe bean bin (same as SERVO_BAD)
...
# ============= SYSTEM SETTINGS =============
# Timing settings
MAIN_LOOP_DELAY = 0.05  # Main loop sleep time (seconds)
BEAN_PROCESS_TIME = 1.0 # Time to wait after sorting before next bean

# Logging settings
LOG_LEVEL = "INFO"  # DEBUG, INFO, WARNING, ERROR, CRITICAL
LOG_FILE = "coffee_sorter.log"

# LED timing
LED_BLINK_DURATION = 0.2  # seconds

# IR Sensor debounce settings
IR_DEBOUNCE_MS = 50  # debounce time in milliseconds

# Servo frequency
SERVO_FREQUENCY = 50  # PWM frequency in Hz

# Color detection thresholds (tune these for your setup)
COLOR_THRESHOLDS = {
    'green_ratio_min': 1.2,   # green/red ratio must be > this
    'red_ratio_min': 1.2,     # red/green ratio must be > this
    'min_difference': 1000      # minimum difference between red and green
}
