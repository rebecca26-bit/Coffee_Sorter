...
# ── Pin Configuration ──────────────────────────────────────────────────────────
PIN_S0  = 31   # Physical board pin numbers
PIN_S1  = 33
PIN_S2  = 35
PIN_S3  = 37
PIN_OUT = 29
PIN_OE  = 22   # Set to None if OE is tied to GND permanently
...
THRESHOLDS = {
    "good_red_min":    110,   # normalised R must be at least this
    "good_rg_margin":  25,    # R must exceed G by at least this
    "good_rb_margin":  25,    # R must exceed B by at least this
